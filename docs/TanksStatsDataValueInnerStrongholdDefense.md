# TanksStatsDataValueInnerStrongholdDefense
...
json = "{}"
# create an instance of TanksStatsDataValueInnerStrongholdDefense from a JSON string
tanks_stats_data_value_inner_stronghold_defense_instance = TanksStatsDataValueInnerStrongholdDefense.from_json(json)
# print the JSON string representation of the object
print(TanksStatsDataValueInnerStrongholdDefense.to_json())

# convert the object into a dict
tanks_stats_data_value_inner_stronghold_defense_dict = tanks_stats_data_value_inner_stronghold_defense_instance.to_dict()
# create an instance of TanksStatsDataValueInnerStrongholdDefense from a dict
tanks_stats_data_value_inner_stronghold_defense_from_dict = TanksStatsDataValueInnerStrongholdDefense.from_dict(tanks_stats_data_value_inner_stronghold_defense_dict)
```
