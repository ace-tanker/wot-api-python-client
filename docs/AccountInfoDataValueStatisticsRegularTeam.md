# AccountInfoDataValueStatisticsRegularTeam
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsRegularTeam from a JSON string
account_info_data_value_statistics_regular_team_instance = AccountInfoDataValueStatisticsRegularTeam.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsRegularTeam.to_json())

# convert the object into a dict
account_info_data_value_statistics_regular_team_dict = account_info_data_value_statistics_regular_team_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsRegularTeam from a dict
account_info_data_value_statistics_regular_team_from_dict = AccountInfoDataValueStatisticsRegularTeam.from_dict(account_info_data_value_statistics_regular_team_dict)
```
