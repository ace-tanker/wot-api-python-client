# GetAccountInfo200ResponseOneOfDataValueStatisticsEpic
...
json = "{}"
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsEpic from a JSON string
get_account_info200_response_one_of_data_value_statistics_epic_instance = GetAccountInfo200ResponseOneOfDataValueStatisticsEpic.from_json(json)
# print the JSON string representation of the object
print(GetAccountInfo200ResponseOneOfDataValueStatisticsEpic.to_json())

# convert the object into a dict
get_account_info200_response_one_of_data_value_statistics_epic_dict = get_account_info200_response_one_of_data_value_statistics_epic_instance.to_dict()
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsEpic from a dict
get_account_info200_response_one_of_data_value_statistics_epic_from_dict = GetAccountInfo200ResponseOneOfDataValueStatisticsEpic.from_dict(get_account_info200_response_one_of_data_value_statistics_epic_dict)
```
