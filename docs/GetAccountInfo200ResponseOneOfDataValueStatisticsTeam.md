# GetAccountInfo200ResponseOneOfDataValueStatisticsTeam
...
json = "{}"
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsTeam from a JSON string
get_account_info200_response_one_of_data_value_statistics_team_instance = GetAccountInfo200ResponseOneOfDataValueStatisticsTeam.from_json(json)
# print the JSON string representation of the object
print(GetAccountInfo200ResponseOneOfDataValueStatisticsTeam.to_json())

# convert the object into a dict
get_account_info200_response_one_of_data_value_statistics_team_dict = get_account_info200_response_one_of_data_value_statistics_team_instance.to_dict()
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsTeam from a dict
get_account_info200_response_one_of_data_value_statistics_team_from_dict = GetAccountInfo200ResponseOneOfDataValueStatisticsTeam.from_dict(get_account_info200_response_one_of_data_value_statistics_team_dict)
```
