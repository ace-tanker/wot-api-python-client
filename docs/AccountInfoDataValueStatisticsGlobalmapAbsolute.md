# AccountInfoDataValueStatisticsGlobalmapAbsolute
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsGlobalmapAbsolute from a JSON string
account_info_data_value_statistics_globalmap_absolute_instance = AccountInfoDataValueStatisticsGlobalmapAbsolute.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsGlobalmapAbsolute.to_json())

# convert the object into a dict
account_info_data_value_statistics_globalmap_absolute_dict = account_info_data_value_statistics_globalmap_absolute_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsGlobalmapAbsolute from a dict
account_info_data_value_statistics_globalmap_absolute_from_dict = AccountInfoDataValueStatisticsGlobalmapAbsolute.from_dict(account_info_data_value_statistics_globalmap_absolute_dict)
```
