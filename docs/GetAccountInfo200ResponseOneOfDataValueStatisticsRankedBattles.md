# GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattles
...
json = "{}"
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattles from a JSON string
get_account_info200_response_one_of_data_value_statistics_ranked_battles_instance = GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattles.from_json(json)
# print the JSON string representation of the object
print(GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattles.to_json())

# convert the object into a dict
get_account_info200_response_one_of_data_value_statistics_ranked_battles_dict = get_account_info200_response_one_of_data_value_statistics_ranked_battles_instance.to_dict()
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattles from a dict
get_account_info200_response_one_of_data_value_statistics_ranked_battles_from_dict = GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattles.from_dict(get_account_info200_response_one_of_data_value_statistics_ranked_battles_dict)
```
