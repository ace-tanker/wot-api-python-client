...
json = "{}"
# create an instance of TanksStatsDataValueInnerAll from a JSON string
tanks_stats_data_value_inner_all_instance = TanksStatsDataValueInnerAll.from_json(json)
# print the JSON string representation of the object
print(TanksStatsDataValueInnerAll.to_json())

# convert the object into a dict
tanks_stats_data_value_inner_all_dict = tanks_stats_data_value_inner_all_instance.to_dict()
# create an instance of TanksStatsDataValueInnerAll from a dict
tanks_stats_data_value_inner_all_from_dict = TanksStatsDataValueInnerAll.from_dict(tanks_stats_data_value_inner_all_dict)
```
