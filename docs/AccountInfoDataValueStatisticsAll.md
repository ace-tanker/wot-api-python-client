# AccountInfoDataValueStatisticsAll
...
**avg_damage_assisted_track** | **float** | Average damage upon your shooting the track. Value is calculated starting from version 8.8. | 
**avg_damage_assisted_radio** | **float** | Average damage upon your spotting. Value is calculated starting from version 8.8. | 
**avg_damage_assisted** | **float** | Average damage caused with your assistance. Value is calculated starting from version 8.8. | 
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsAll from a JSON string
account_info_data_value_statistics_all_instance = AccountInfoDataValueStatisticsAll.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsAll.to_json())

# convert the object into a dict
account_info_data_value_statistics_all_dict = account_info_data_value_statistics_all_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsAll from a dict
account_info_data_value_statistics_all_from_dict = AccountInfoDataValueStatisticsAll.from_dict(account_info_data_value_statistics_all_dict)
```
