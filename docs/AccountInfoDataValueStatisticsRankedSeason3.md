# AccountInfoDataValueStatisticsRankedSeason3
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsRankedSeason3 from a JSON string
account_info_data_value_statistics_ranked_season3_instance = AccountInfoDataValueStatisticsRankedSeason3.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsRankedSeason3.to_json())

# convert the object into a dict
account_info_data_value_statistics_ranked_season3_dict = account_info_data_value_statistics_ranked_season3_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsRankedSeason3 from a dict
account_info_data_value_statistics_ranked_season3_from_dict = AccountInfoDataValueStatisticsRankedSeason3.from_dict(account_info_data_value_statistics_ranked_season3_dict)
```
