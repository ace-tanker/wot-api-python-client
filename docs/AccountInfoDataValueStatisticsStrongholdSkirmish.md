# AccountInfoDataValueStatisticsStrongholdSkirmish
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsStrongholdSkirmish from a JSON string
account_info_data_value_statistics_stronghold_skirmish_instance = AccountInfoDataValueStatisticsStrongholdSkirmish.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsStrongholdSkirmish.to_json())

# convert the object into a dict
account_info_data_value_statistics_stronghold_skirmish_dict = account_info_data_value_statistics_stronghold_skirmish_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsStrongholdSkirmish from a dict
account_info_data_value_statistics_stronghold_skirmish_from_dict = AccountInfoDataValueStatisticsStrongholdSkirmish.from_dict(account_info_data_value_statistics_stronghold_skirmish_dict)
```
