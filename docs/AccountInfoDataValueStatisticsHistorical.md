# AccountInfoDataValueStatisticsHistorical
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsHistorical from a JSON string
account_info_data_value_statistics_historical_instance = AccountInfoDataValueStatisticsHistorical.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsHistorical.to_json())

# convert the object into a dict
account_info_data_value_statistics_historical_dict = account_info_data_value_statistics_historical_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsHistorical from a dict
account_info_data_value_statistics_historical_from_dict = AccountInfoDataValueStatisticsHistorical.from_dict(account_info_data_value_statistics_historical_dict)
```
