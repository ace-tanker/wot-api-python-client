# AccountInfoDataValueStatisticsRankedBattlesCurrent
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsRankedBattlesCurrent from a JSON string
account_info_data_value_statistics_ranked_battles_current_instance = AccountInfoDataValueStatisticsRankedBattlesCurrent.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsRankedBattlesCurrent.to_json())

# convert the object into a dict
account_info_data_value_statistics_ranked_battles_current_dict = account_info_data_value_statistics_ranked_battles_current_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsRankedBattlesCurrent from a dict
account_info_data_value_statistics_ranked_battles_current_from_dict = AccountInfoDataValueStatisticsRankedBattlesCurrent.from_dict(account_info_data_value_statistics_ranked_battles_current_dict)
```
