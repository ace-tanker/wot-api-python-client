# TanksStatsDataValueInnerGlobalmap
...
json = "{}"
# create an instance of TanksStatsDataValueInnerGlobalmap from a JSON string
tanks_stats_data_value_inner_globalmap_instance = TanksStatsDataValueInnerGlobalmap.from_json(json)
# print the JSON string representation of the object
print(TanksStatsDataValueInnerGlobalmap.to_json())

# convert the object into a dict
tanks_stats_data_value_inner_globalmap_dict = tanks_stats_data_value_inner_globalmap_instance.to_dict()
# create an instance of TanksStatsDataValueInnerGlobalmap from a dict
tanks_stats_data_value_inner_globalmap_from_dict = TanksStatsDataValueInnerGlobalmap.from_dict(tanks_stats_data_value_inner_globalmap_dict)
```
