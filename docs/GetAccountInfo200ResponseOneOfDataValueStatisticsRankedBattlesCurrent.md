# GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesCurrent
...
json = "{}"
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesCurrent from a JSON string
get_account_info200_response_one_of_data_value_statistics_ranked_battles_current_instance = GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesCurrent.from_json(json)
# print the JSON string representation of the object
print(GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesCurrent.to_json())

# convert the object into a dict
get_account_info200_response_one_of_data_value_statistics_ranked_battles_current_dict = get_account_info200_response_one_of_data_value_statistics_ranked_battles_current_instance.to_dict()
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesCurrent from a dict
get_account_info200_response_one_of_data_value_statistics_ranked_battles_current_from_dict = GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesCurrent.from_dict(get_account_info200_response_one_of_data_value_statistics_ranked_battles_current_dict)
```
