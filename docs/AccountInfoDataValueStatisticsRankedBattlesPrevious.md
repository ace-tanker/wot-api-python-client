# AccountInfoDataValueStatisticsRankedBattlesPrevious
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsRankedBattlesPrevious from a JSON string
account_info_data_value_statistics_ranked_battles_previous_instance = AccountInfoDataValueStatisticsRankedBattlesPrevious.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsRankedBattlesPrevious.to_json())

# convert the object into a dict
account_info_data_value_statistics_ranked_battles_previous_dict = account_info_data_value_statistics_ranked_battles_previous_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsRankedBattlesPrevious from a dict
account_info_data_value_statistics_ranked_battles_previous_from_dict = AccountInfoDataValueStatisticsRankedBattlesPrevious.from_dict(account_info_data_value_statistics_ranked_battles_previous_dict)
```
