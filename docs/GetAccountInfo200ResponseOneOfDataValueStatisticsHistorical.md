# GetAccountInfo200ResponseOneOfDataValueStatisticsHistorical
...
json = "{}"
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsHistorical from a JSON string
get_account_info200_response_one_of_data_value_statistics_historical_instance = GetAccountInfo200ResponseOneOfDataValueStatisticsHistorical.from_json(json)
# print the JSON string representation of the object
print(GetAccountInfo200ResponseOneOfDataValueStatisticsHistorical.to_json())

# convert the object into a dict
get_account_info200_response_one_of_data_value_statistics_historical_dict = get_account_info200_response_one_of_data_value_statistics_historical_instance.to_dict()
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsHistorical from a dict
get_account_info200_response_one_of_data_value_statistics_historical_from_dict = GetAccountInfo200ResponseOneOfDataValueStatisticsHistorical.from_dict(get_account_info200_response_one_of_data_value_statistics_historical_dict)
```
