# AccountInfoDataValueStatisticsRankedSeason1
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsRankedSeason1 from a JSON string
account_info_data_value_statistics_ranked_season1_instance = AccountInfoDataValueStatisticsRankedSeason1.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsRankedSeason1.to_json())

# convert the object into a dict
account_info_data_value_statistics_ranked_season1_dict = account_info_data_value_statistics_ranked_season1_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsRankedSeason1 from a dict
account_info_data_value_statistics_ranked_season1_from_dict = AccountInfoDataValueStatisticsRankedSeason1.from_dict(account_info_data_value_statistics_ranked_season1_dict)
```
