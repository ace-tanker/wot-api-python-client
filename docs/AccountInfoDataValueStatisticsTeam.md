# AccountInfoDataValueStatisticsTeam
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsTeam from a JSON string
account_info_data_value_statistics_team_instance = AccountInfoDataValueStatisticsTeam.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsTeam.to_json())

# convert the object into a dict
account_info_data_value_statistics_team_dict = account_info_data_value_statistics_team_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsTeam from a dict
account_info_data_value_statistics_team_from_dict = AccountInfoDataValueStatisticsTeam.from_dict(account_info_data_value_statistics_team_dict)
```
