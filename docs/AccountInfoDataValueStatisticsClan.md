# AccountInfoDataValueStatisticsClan
...
account_info_data_value_statistics_clan_instance = AccountInfoDataValueStatisticsClan.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsClan.to_json())

# convert the object into a dict
account_info_data_value_statistics_clan_dict = account_info_data_value_statistics_clan_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsClan from a dict
account_info_data_value_statistics_clan_from_dict = AccountInfoDataValueStatisticsClan.from_dict(account_info_data_value_statistics_clan_dict)
```
