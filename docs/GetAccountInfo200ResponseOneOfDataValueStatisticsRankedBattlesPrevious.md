# GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesPrevious
...
json = "{}"
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesPrevious from a JSON string
get_account_info200_response_one_of_data_value_statistics_ranked_battles_previous_instance = GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesPrevious.from_json(json)
# print the JSON string representation of the object
print(GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesPrevious.to_json())

# convert the object into a dict
get_account_info200_response_one_of_data_value_statistics_ranked_battles_previous_dict = get_account_info200_response_one_of_data_value_statistics_ranked_battles_previous_instance.to_dict()
# create an instance of GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesPrevious from a dict
get_account_info200_response_one_of_data_value_statistics_ranked_battles_previous_from_dict = GetAccountInfo200ResponseOneOfDataValueStatisticsRankedBattlesPrevious.from_dict(get_account_info200_response_one_of_data_value_statistics_ranked_battles_previous_dict)
```
