# GetTanksStats200ResponseOneOfDataValueInnerGlobalmap
...
json = "{}"
# create an instance of GetTanksStats200ResponseOneOfDataValueInnerGlobalmap from a JSON string
get_tanks_stats200_response_one_of_data_value_inner_globalmap_instance = GetTanksStats200ResponseOneOfDataValueInnerGlobalmap.from_json(json)
# print the JSON string representation of the object
print(GetTanksStats200ResponseOneOfDataValueInnerGlobalmap.to_json())

# convert the object into a dict
get_tanks_stats200_response_one_of_data_value_inner_globalmap_dict = get_tanks_stats200_response_one_of_data_value_inner_globalmap_instance.to_dict()
# create an instance of GetTanksStats200ResponseOneOfDataValueInnerGlobalmap from a dict
get_tanks_stats200_response_one_of_data_value_inner_globalmap_from_dict = GetTanksStats200ResponseOneOfDataValueInnerGlobalmap.from_dict(get_tanks_stats200_response_one_of_data_value_inner_globalmap_dict)
```
