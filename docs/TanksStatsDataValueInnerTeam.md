...
json = "{}"
# create an instance of TanksStatsDataValueInnerTeam from a JSON string
tanks_stats_data_value_inner_team_instance = TanksStatsDataValueInnerTeam.from_json(json)
# print the JSON string representation of the object
print(TanksStatsDataValueInnerTeam.to_json())

# convert the object into a dict
tanks_stats_data_value_inner_team_dict = tanks_stats_data_value_inner_team_instance.to_dict()
# create an instance of TanksStatsDataValueInnerTeam from a dict
tanks_stats_data_value_inner_team_from_dict = TanksStatsDataValueInnerTeam.from_dict(tanks_stats_data_value_inner_team_dict)
```
