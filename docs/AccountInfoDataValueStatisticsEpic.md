# AccountInfoDataValueStatisticsEpic
...
account_info_data_value_statistics_epic_instance = AccountInfoDataValueStatisticsEpic.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsEpic.to_json())

# convert the object into a dict
account_info_data_value_statistics_epic_dict = account_info_data_value_statistics_epic_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsEpic from a dict
account_info_data_value_statistics_epic_from_dict = AccountInfoDataValueStatisticsEpic.from_dict(account_info_data_value_statistics_epic_dict)
```
