# AccountInfoDataValueStatisticsGlobalmapChampion
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsGlobalmapChampion from a JSON string
account_info_data_value_statistics_globalmap_champion_instance = AccountInfoDataValueStatisticsGlobalmapChampion.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsGlobalmapChampion.to_json())

# convert the object into a dict
account_info_data_value_statistics_globalmap_champion_dict = account_info_data_value_statistics_globalmap_champion_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsGlobalmapChampion from a dict
account_info_data_value_statistics_globalmap_champion_from_dict = AccountInfoDataValueStatisticsGlobalmapChampion.from_dict(account_info_data_value_statistics_globalmap_champion_dict)
```
