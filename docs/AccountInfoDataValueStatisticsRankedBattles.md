# AccountInfoDataValueStatisticsRankedBattles
...
json = "{}"
# create an instance of AccountInfoDataValueStatisticsRankedBattles from a JSON string
account_info_data_value_statistics_ranked_battles_instance = AccountInfoDataValueStatisticsRankedBattles.from_json(json)
# print the JSON string representation of the object
print(AccountInfoDataValueStatisticsRankedBattles.to_json())

# convert the object into a dict
account_info_data_value_statistics_ranked_battles_dict = account_info_data_value_statistics_ranked_battles_instance.to_dict()
# create an instance of AccountInfoDataValueStatisticsRankedBattles from a dict
account_info_data_value_statistics_ranked_battles_from_dict = AccountInfoDataValueStatisticsRankedBattles.from_dict(account_info_data_value_statistics_ranked_battles_dict)
```
