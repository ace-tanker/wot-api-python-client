# GetTanksStats200ResponseOneOfDataValueInnerAll
...
json = "{}"
# create an instance of GetTanksStats200ResponseOneOfDataValueInnerAll from a JSON string
get_tanks_stats200_response_one_of_data_value_inner_all_instance = GetTanksStats200ResponseOneOfDataValueInnerAll.from_json(json)
# print the JSON string representation of the object
print(GetTanksStats200ResponseOneOfDataValueInnerAll.to_json())

# convert the object into a dict
get_tanks_stats200_response_one_of_data_value_inner_all_dict = get_tanks_stats200_response_one_of_data_value_inner_all_instance.to_dict()
# create an instance of GetTanksStats200ResponseOneOfDataValueInnerAll from a dict
get_tanks_stats200_response_one_of_data_value_inner_all_from_dict = GetTanksStats200ResponseOneOfDataValueInnerAll.from_dict(get_tanks_stats200_response_one_of_data_value_inner_all_dict)
```
