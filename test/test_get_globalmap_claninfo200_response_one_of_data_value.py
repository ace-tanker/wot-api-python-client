...
class TestGetGlobalmapClaninfo200ResponseOneOfDataValue(unittest.TestCase):
    """GetGlobalmapClaninfo200ResponseOneOfDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlobalmapClaninfo200ResponseOneOfDataValue:
        """Test GetGlobalmapClaninfo200ResponseOneOfDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlobalmapClaninfo200ResponseOneOfDataValue`
        """
        model = GetGlobalmapClaninfo200ResponseOneOfDataValue()
        if include_optional:
            return GetGlobalmapClaninfo200ResponseOneOfDataValue(
                clan_id = 56,
                tag = '',
                name = '',
    ...
    def testGetGlobalmapClaninfo200ResponseOneOfDataValue(self):
        """Test GetGlobalmapClaninfo200ResponseOneOfDataValue"""
