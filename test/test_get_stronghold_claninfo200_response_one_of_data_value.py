...
class TestGetStrongholdClaninfo200ResponseOneOfDataValue(unittest.TestCase):
    """GetStrongholdClaninfo200ResponseOneOfDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStrongholdClaninfo200ResponseOneOfDataValue:
        """Test GetStrongholdClaninfo200ResponseOneOfDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStrongholdClaninfo200ResponseOneOfDataValue`
        """
        model = GetStrongholdClaninfo200ResponseOneOfDataValue()
        if include_optional:
            return GetStrongholdClaninfo200ResponseOneOfDataValue(
                clan_id = 56,
                clan_name = '',
                clan_tag = '',
                stronghold_level = 56,
    ...
    def testGetStrongholdClaninfo200ResponseOneOfDataValue(self):
        """Test GetStrongholdClaninfo200ResponseOneOfDataValue"""
