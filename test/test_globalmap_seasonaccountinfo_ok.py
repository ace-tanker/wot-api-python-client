...
class TestGlobalmapSeasonaccountinfoOk(unittest.TestCase):
    """GlobalmapSeasonaccountinfoOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlobalmapSeasonaccountinfoOk:
        """Test GlobalmapSeasonaccountinfoOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlobalmapSeasonaccountinfoOk`
        """
        model = GlobalmapSeasonaccountinfoOk()
        if include_optional:
            return GlobalmapSeasonaccountinfoOk(
                status = 'ok',
    ...
    def testGlobalmapSeasonaccountinfoOk(self):
        """Test GlobalmapSeasonaccountinfoOk"""
