...
class TestGetGlobalmapProvinces200ResponseOneOfDataInner(unittest.TestCase):
    """GetGlobalmapProvinces200ResponseOneOfDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlobalmapProvinces200ResponseOneOfDataInner:
        """Test GetGlobalmapProvinces200ResponseOneOfDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlobalmapProvinces200ResponseOneOfDataInner`
        """
        model = GetGlobalmapProvinces200ResponseOneOfDataInner()
        if include_optional:
            return GetGlobalmapProvinces200ResponseOneOfDataInner(
                arena_id = '',
                arena_name = '',
                daily_revenue = 56,
                front_id = '',
    ...
    def testGetGlobalmapProvinces200ResponseOneOfDataInner(self):
        """Test GetGlobalmapProvinces200ResponseOneOfDataInner"""
