...
class TestGetEncyclopediaBoosters200ResponseOneOf(unittest.TestCase):
    """GetEncyclopediaBoosters200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaBoosters200ResponseOneOf:
        """Test GetEncyclopediaBoosters200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaBoosters200ResponseOneOf`
        """
        model = GetEncyclopediaBoosters200ResponseOneOf()
        if include_optional:
            return GetEncyclopediaBoosters200ResponseOneOf(
                status = 'ok',
    ...
    def testGetEncyclopediaBoosters200ResponseOneOf(self):
        """Test GetEncyclopediaBoosters200ResponseOneOf"""
