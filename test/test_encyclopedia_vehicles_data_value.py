...
class TestEncyclopediaVehiclesDataValue(unittest.TestCase):
    """EncyclopediaVehiclesDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncyclopediaVehiclesDataValue:
        """Test EncyclopediaVehiclesDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncyclopediaVehiclesDataValue`
        """
        model = EncyclopediaVehiclesDataValue()
        if include_optional:
            return EncyclopediaVehiclesDataValue(
                tank_id = 56,
                type = '',
                tag = '',
                name = '',
    ...
    def testEncyclopediaVehiclesDataValue(self):
        """Test EncyclopediaVehiclesDataValue"""
