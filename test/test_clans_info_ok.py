...
class TestClansInfoOk(unittest.TestCase):
    """ClansInfoOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClansInfoOk:
        """Test ClansInfoOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClansInfoOk`
        """
        model = ClansInfoOk()
        if include_optional:
            return ClansInfoOk(
