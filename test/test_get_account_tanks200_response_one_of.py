...
class TestGetAccountTanks200ResponseOneOf(unittest.TestCase):
    """GetAccountTanks200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountTanks200ResponseOneOf:
        """Test GetAccountTanks200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountTanks200ResponseOneOf`
        """
        model = GetAccountTanks200ResponseOneOf()
        if include_optional:
            return GetAccountTanks200ResponseOneOf(
                status = 'ok',
    ...
    def testGetAccountTanks200ResponseOneOf(self):
        """Test GetAccountTanks200ResponseOneOf"""
