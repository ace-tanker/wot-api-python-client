...
class TestGlobalmapProvincesOk(unittest.TestCase):
    """GlobalmapProvincesOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlobalmapProvincesOk:
        """Test GlobalmapProvincesOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlobalmapProvincesOk`
        """
        model = GlobalmapProvincesOk()
        if include_optional:
            return GlobalmapProvincesOk(
                status = 'ok',
    ...
    def testGlobalmapProvincesOk(self):
        """Test GlobalmapProvincesOk"""
