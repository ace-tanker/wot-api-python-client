...
class TestAccountInfoOk(unittest.TestCase):
    """AccountInfoOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountInfoOk:
        """Test AccountInfoOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountInfoOk`
        """
        model = AccountInfoOk()
        if include_optional:
