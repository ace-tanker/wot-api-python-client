...
class TestClanratingsTopOk(unittest.TestCase):
    """ClanratingsTopOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClanratingsTopOk:
        """Test ClanratingsTopOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClanratingsTopOk`
        """
        model = ClanratingsTopOk()
        if include_optional:
            return ClanratingsTopOk(
                status = 'ok',
