...
class TestTanksStatsDataValueInner(unittest.TestCase):
    """TanksStatsDataValueInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TanksStatsDataValueInner:
        """Test TanksStatsDataValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TanksStatsDataValueInner`
        """
        model = TanksStatsDataValueInner()
        if include_optional:
            return TanksStatsDataValueInner(
                account_id = 56,
                tank_id = 56,
    ...
    def testTanksStatsDataValueInner(self):
        """Test TanksStatsDataValueInner"""
