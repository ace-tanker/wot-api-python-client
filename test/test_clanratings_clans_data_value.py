...
class TestClanratingsClansDataValue(unittest.TestCase):
    """ClanratingsClansDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClanratingsClansDataValue:
        """Test ClanratingsClansDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClanratingsClansDataValue`
        """
        model = ClanratingsClansDataValue()
        if include_optional:
            return ClanratingsClansDataValue(
                clan_id = 56,
                clan_name = '',
                clan_tag = '',
    ...
    def testClanratingsClansDataValue(self):
        """Test ClanratingsClansDataValue"""
