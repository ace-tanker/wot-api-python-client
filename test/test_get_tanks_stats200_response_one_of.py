...
class TestGetTanksStats200ResponseOneOf(unittest.TestCase):
    """GetTanksStats200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTanksStats200ResponseOneOf:
        """Test GetTanksStats200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTanksStats200ResponseOneOf`
        """
        model = GetTanksStats200ResponseOneOf()
        if include_optional:
            return GetTanksStats200ResponseOneOf(
                status = 'ok',
    ...
    def testGetTanksStats200ResponseOneOf(self):
        """Test GetTanksStats200ResponseOneOf"""
