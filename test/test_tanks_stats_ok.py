...
class TestTanksStatsOk(unittest.TestCase):
    """TanksStatsOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TanksStatsOk:
        """Test TanksStatsOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TanksStatsOk`
        """
        model = TanksStatsOk()
        if include_optional:
            return TanksStatsOk(
