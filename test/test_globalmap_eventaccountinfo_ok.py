...
class TestGlobalmapEventaccountinfoOk(unittest.TestCase):
    """GlobalmapEventaccountinfoOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlobalmapEventaccountinfoOk:
        """Test GlobalmapEventaccountinfoOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlobalmapEventaccountinfoOk`
        """
        model = GlobalmapEventaccountinfoOk()
        if include_optional:
            return GlobalmapEventaccountinfoOk(
                status = 'ok',
    ...
    def testGlobalmapEventaccountinfoOk(self):
        """Test GlobalmapEventaccountinfoOk"""
