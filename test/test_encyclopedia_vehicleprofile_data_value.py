...
class TestEncyclopediaVehicleprofileDataValue(unittest.TestCase):
    """EncyclopediaVehicleprofileDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncyclopediaVehicleprofileDataValue:
        """Test EncyclopediaVehicleprofileDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncyclopediaVehicleprofileDataValue`
        """
        model = EncyclopediaVehicleprofileDataValue()
        if include_optional:
            return EncyclopediaVehicleprofileDataValue(
                hp = 56,
                hull_hp = 56,
                weight = 56,
                hull_weight = 56,
    ...
    def testEncyclopediaVehicleprofileDataValue(self):
        """Test EncyclopediaVehicleprofileDataValue"""
