...
class TestGetAccountInfo200ResponseOneOfDataValueStatistics(unittest.TestCase):
    """GetAccountInfo200ResponseOneOfDataValueStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountInfo200ResponseOneOfDataValueStatistics:
        """Test GetAccountInfo200ResponseOneOfDataValueStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountInfo200ResponseOneOfDataValueStatistics`
        """
        model = GetAccountInfo200ResponseOneOfDataValueStatistics()
        if include_optional:
            return GetAccountInfo200ResponseOneOfDataValueStatistics(
                trees_cut = 56,
    ...
    def testGetAccountInfo200ResponseOneOfDataValueStatistics(self):
        """Test GetAccountInfo200ResponseOneOfDataValueStatistics"""
