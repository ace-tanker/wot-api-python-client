...
class TestGlobalmapFrontsOk(unittest.TestCase):
    """GlobalmapFrontsOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlobalmapFrontsOk:
        """Test GlobalmapFrontsOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlobalmapFrontsOk`
        """
        model = GlobalmapFrontsOk()
        if include_optional:
            return GlobalmapFrontsOk(
                status = 'ok',
    ...
    def testGlobalmapFrontsOk(self):
        """Test GlobalmapFrontsOk"""
