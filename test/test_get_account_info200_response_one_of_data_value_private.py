...
class TestGetAccountInfo200ResponseOneOfDataValuePrivate(unittest.TestCase):
    """GetAccountInfo200ResponseOneOfDataValuePrivate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountInfo200ResponseOneOfDataValuePrivate:
        """Test GetAccountInfo200ResponseOneOfDataValuePrivate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountInfo200ResponseOneOfDataValuePrivate`
        """
        model = GetAccountInfo200ResponseOneOfDataValuePrivate()
        if include_optional:
            return GetAccountInfo200ResponseOneOfDataValuePrivate(
                personal_missions = {
                    'key' : ''
                    },
                gold = 56,
    ...
    def testGetAccountInfo200ResponseOneOfDataValuePrivate(self):
        """Test GetAccountInfo200ResponseOneOfDataValuePrivate"""
