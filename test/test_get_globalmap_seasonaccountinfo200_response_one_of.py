...
class TestGetGlobalmapSeasonaccountinfo200ResponseOneOf(unittest.TestCase):
    """GetGlobalmapSeasonaccountinfo200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlobalmapSeasonaccountinfo200ResponseOneOf:
        """Test GetGlobalmapSeasonaccountinfo200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlobalmapSeasonaccountinfo200ResponseOneOf`
        """
        model = GetGlobalmapSeasonaccountinfo200ResponseOneOf()
        if include_optional:
            return GetGlobalmapSeasonaccountinfo200ResponseOneOf(
                status = 'ok',
    ...
    def testGetGlobalmapSeasonaccountinfo200ResponseOneOf(self):
        """Test GetGlobalmapSeasonaccountinfo200ResponseOneOf"""
