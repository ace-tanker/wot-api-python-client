...
class TestClanratingsNeighborsOk(unittest.TestCase):
    """ClanratingsNeighborsOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClanratingsNeighborsOk:
        """Test ClanratingsNeighborsOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClanratingsNeighborsOk`
        """
        model = ClanratingsNeighborsOk()
        if include_optional:
            return ClanratingsNeighborsOk(
                status = 'ok',
    ...
    def testClanratingsNeighborsOk(self):
        """Test ClanratingsNeighborsOk"""
