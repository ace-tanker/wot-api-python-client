...
class TestEncyclopediaPersonalmissionsDataValue(unittest.TestCase):
    """EncyclopediaPersonalmissionsDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncyclopediaPersonalmissionsDataValue:
        """Test EncyclopediaPersonalmissionsDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncyclopediaPersonalmissionsDataValue`
        """
        model = EncyclopediaPersonalmissionsDataValue()
        if include_optional:
            return EncyclopediaPersonalmissionsDataValue(
                campaign_id = 56,
                name = '',
                description = '',
                operations = {
    ...
    def testEncyclopediaPersonalmissionsDataValue(self):
        """Test EncyclopediaPersonalmissionsDataValue"""
