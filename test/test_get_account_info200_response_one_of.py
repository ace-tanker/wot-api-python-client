...
class TestGetAccountInfo200ResponseOneOf(unittest.TestCase):
    """GetAccountInfo200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountInfo200ResponseOneOf:
        """Test GetAccountInfo200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountInfo200ResponseOneOf`
        """
        model = GetAccountInfo200ResponseOneOf()
        if include_optional:
            return GetAccountInfo200ResponseOneOf(
                status = 'ok',
    ...
    def testGetAccountInfo200ResponseOneOf(self):
        """Test GetAccountInfo200ResponseOneOf"""
