...
class TestGetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile(unittest.TestCase):
    """GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile:
        """Test GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile`
        """
        model = GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile()
        if include_optional:
            return GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile(
                hp = 56,
                hull_hp = 56,
                weight = 56,
                hull_weight = 56,
    ...
    def testGetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile(self):
        """Test GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile"""
