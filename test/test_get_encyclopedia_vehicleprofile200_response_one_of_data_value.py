...
class TestGetEncyclopediaVehicleprofile200ResponseOneOfDataValue(unittest.TestCase):
    """GetEncyclopediaVehicleprofile200ResponseOneOfDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaVehicleprofile200ResponseOneOfDataValue:
        """Test GetEncyclopediaVehicleprofile200ResponseOneOfDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaVehicleprofile200ResponseOneOfDataValue`
        """
        model = GetEncyclopediaVehicleprofile200ResponseOneOfDataValue()
        if include_optional:
            return GetEncyclopediaVehicleprofile200ResponseOneOfDataValue(
                hp = 56,
                hull_hp = 56,
                weight = 56,
                hull_weight = 56,
    ...
    def testGetEncyclopediaVehicleprofile200ResponseOneOfDataValue(self):
        """Test GetEncyclopediaVehicleprofile200ResponseOneOfDataValue"""
