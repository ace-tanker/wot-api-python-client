...
class TestAccountInfoDataValueStatistics(unittest.TestCase):
    """AccountInfoDataValueStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountInfoDataValueStatistics:
        """Test AccountInfoDataValueStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountInfoDataValueStatistics`
        """
        model = AccountInfoDataValueStatistics()
        if include_optional:
            return AccountInfoDataValueStatistics(
                trees_cut = 56,
    ...
    def testAccountInfoDataValueStatistics(self):
        """Test AccountInfoDataValueStatistics"""
