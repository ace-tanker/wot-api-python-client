...
class TestGetEncyclopediaBadges200ResponseOneOf(unittest.TestCase):
    """GetEncyclopediaBadges200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaBadges200ResponseOneOf:
        """Test GetEncyclopediaBadges200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaBadges200ResponseOneOf`
        """
        model = GetEncyclopediaBadges200ResponseOneOf()
        if include_optional:
            return GetEncyclopediaBadges200ResponseOneOf(
                status = 'ok',
    ...
    def testGetEncyclopediaBadges200ResponseOneOf(self):
        """Test GetEncyclopediaBadges200ResponseOneOf"""
