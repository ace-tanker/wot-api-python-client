...
class TestEncyclopediaVehiclesOk(unittest.TestCase):
    """EncyclopediaVehiclesOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncyclopediaVehiclesOk:
        """Test EncyclopediaVehiclesOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncyclopediaVehiclesOk`
        """
        model = EncyclopediaVehiclesOk()
        if include_optional:
            return EncyclopediaVehiclesOk(
                status = 'ok',
    ...
    def testEncyclopediaVehiclesOk(self):
        """Test EncyclopediaVehiclesOk"""
