...
class TestGetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue(unittest.TestCase):
    """GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue:
        """Test GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue`
        """
        model = GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue()
        if include_optional:
            return GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue(
                operation_id = 56,
                name = '',
                description = '',
                image = '',
    ...
    def testGetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue(self):
        """Test GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue"""
