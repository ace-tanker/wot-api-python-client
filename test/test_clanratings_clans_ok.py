...
class TestClanratingsClansOk(unittest.TestCase):
    """ClanratingsClansOk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClanratingsClansOk:
        """Test ClanratingsClansOk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClanratingsClansOk`
        """
        model = ClanratingsClansOk()
        if include_optional:
            return ClanratingsClansOk(
                status = 'ok',
    ...
    def testClanratingsClansOk(self):
        """Test ClanratingsClansOk"""
