...
class TestGetEncyclopediaVehicles200ResponseOneOfDataValue(unittest.TestCase):
    """GetEncyclopediaVehicles200ResponseOneOfDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaVehicles200ResponseOneOfDataValue:
        """Test GetEncyclopediaVehicles200ResponseOneOfDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaVehicles200ResponseOneOfDataValue`
        """
        model = GetEncyclopediaVehicles200ResponseOneOfDataValue()
        if include_optional:
            return GetEncyclopediaVehicles200ResponseOneOfDataValue(
                tank_id = 56,
                type = '',
                tag = '',
                name = '',
    ...
    def testGetEncyclopediaVehicles200ResponseOneOfDataValue(self):
        """Test GetEncyclopediaVehicles200ResponseOneOfDataValue"""
