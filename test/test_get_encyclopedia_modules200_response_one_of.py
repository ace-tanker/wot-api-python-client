...
class TestGetEncyclopediaModules200ResponseOneOf(unittest.TestCase):
    """GetEncyclopediaModules200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaModules200ResponseOneOf:
        """Test GetEncyclopediaModules200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaModules200ResponseOneOf`
        """
        model = GetEncyclopediaModules200ResponseOneOf()
        if include_optional:
            return GetEncyclopediaModules200ResponseOneOf(
                status = 'ok',
    ...
    def testGetEncyclopediaModules200ResponseOneOf(self):
        """Test GetEncyclopediaModules200ResponseOneOf"""
