...
class TestGetTanksStats200ResponseOneOfDataValueInner(unittest.TestCase):
    """GetTanksStats200ResponseOneOfDataValueInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTanksStats200ResponseOneOfDataValueInner:
        """Test GetTanksStats200ResponseOneOfDataValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTanksStats200ResponseOneOfDataValueInner`
        """
        model = GetTanksStats200ResponseOneOfDataValueInner()
        if include_optional:
            return GetTanksStats200ResponseOneOfDataValueInner(
                account_id = 56,
                tank_id = 56,
    ...
    def testGetTanksStats200ResponseOneOfDataValueInner(self):
        """Test GetTanksStats200ResponseOneOfDataValueInner"""
