...
class TestGetEncyclopediaVehicles200ResponseOneOf(unittest.TestCase):
    """GetEncyclopediaVehicles200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaVehicles200ResponseOneOf:
        """Test GetEncyclopediaVehicles200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaVehicles200ResponseOneOf`
        """
        model = GetEncyclopediaVehicles200ResponseOneOf()
        if include_optional:
            return GetEncyclopediaVehicles200ResponseOneOf(
                status = 'ok',
    ...
    def testGetEncyclopediaVehicles200ResponseOneOf(self):
        """Test GetEncyclopediaVehicles200ResponseOneOf"""
