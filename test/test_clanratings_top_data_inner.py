...
class TestClanratingsTopDataInner(unittest.TestCase):
    """ClanratingsTopDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClanratingsTopDataInner:
        """Test ClanratingsTopDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClanratingsTopDataInner`
        """
        model = ClanratingsTopDataInner()
        if include_optional:
            return ClanratingsTopDataInner(
                clan_id = 56,
                clan_name = '',
                clan_tag = '',
    ...
    def testClanratingsTopDataInner(self):
        """Test ClanratingsTopDataInner"""
