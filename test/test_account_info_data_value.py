...
class TestAccountInfoDataValue(unittest.TestCase):
    """AccountInfoDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountInfoDataValue:
        """Test AccountInfoDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountInfoDataValue`
        """
        model = AccountInfoDataValue()
        if include_optional:
            return AccountInfoDataValue(
    ...
    def testAccountInfoDataValue(self):
        """Test AccountInfoDataValue"""
