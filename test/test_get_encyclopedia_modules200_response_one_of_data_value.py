...
class TestGetEncyclopediaModules200ResponseOneOfDataValue(unittest.TestCase):
    """GetEncyclopediaModules200ResponseOneOfDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaModules200ResponseOneOfDataValue:
        """Test GetEncyclopediaModules200ResponseOneOfDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaModules200ResponseOneOfDataValue`
        """
        model = GetEncyclopediaModules200ResponseOneOfDataValue()
        if include_optional:
            return GetEncyclopediaModules200ResponseOneOfDataValue(
                module_id = 56,
                type = '',
                name = '',
                price_credit = 56,
    ...
    def testGetEncyclopediaModules200ResponseOneOfDataValue(self):
        """Test GetEncyclopediaModules200ResponseOneOfDataValue"""
