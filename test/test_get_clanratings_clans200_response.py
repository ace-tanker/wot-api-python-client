    ...
    def make_instance(self, include_optional) -> GetClanratingsClans200Response:
        ...
        if include_optional:
            return GetClanratingsClans200Response(
                status = 'error',
                meta = wot_api_client.models.clanratings_clans_meta.clanratings_clans_meta(
                    count = 56, ),
                data = {
                    'key' : wot_api_client.models.clanratings_clans_data_value.clanratings_clans_data_value(
                        clan_id = 56, 
                        clan_name = '', 
                        clan_tag = '', 
