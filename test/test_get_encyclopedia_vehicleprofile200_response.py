...
class TestGetEncyclopediaVehicleprofile200Response(unittest.TestCase):
    """GetEncyclopediaVehicleprofile200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEncyclopediaVehicleprofile200Response:
        """Test GetEncyclopediaVehicleprofile200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEncyclopediaVehicleprofile200Response`
        """
        model = GetEncyclopediaVehicleprofile200Response()
        if include_optional:
            return GetEncyclopediaVehicleprofile200Response(
                status = 'error',
                meta = wot_api_client.models.encyclopedia_vehicleprofile_meta.encyclopedia_vehicleprofile_meta(
                    count = 56, ),
                data = {
                    'key' : wot_api_client.models.encyclopedia_vehicleprofile_data_value.encyclopedia_vehicleprofile_data_value(
                        hp = 56, 
                        hull_hp = 56, 
                        weight = 56, 
                        hull_weight = 56, 
    ...
    def testGetEncyclopediaVehicleprofile200Response(self):
        """Test GetEncyclopediaVehicleprofile200Response"""
