...
class TestGetGlobalmapFronts200ResponseOneOf(unittest.TestCase):
    """GetGlobalmapFronts200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlobalmapFronts200ResponseOneOf:
        """Test GetGlobalmapFronts200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlobalmapFronts200ResponseOneOf`
        """
        model = GetGlobalmapFronts200ResponseOneOf()
        if include_optional:
            return GetGlobalmapFronts200ResponseOneOf(
                status = 'ok',
    ...
    def testGetGlobalmapFronts200ResponseOneOf(self):
        """Test GetGlobalmapFronts200ResponseOneOf"""
