...
class AccountInfoOk(BaseModel):
    """
    AccountInfoOk
    """ # noqa: E501
    status: StrictStr
    meta: AccountInfoMeta
    data: Optional[Dict[str, Optional[AccountInfoDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": AccountInfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, AccountInfoDataValue.from_dict(_v))
