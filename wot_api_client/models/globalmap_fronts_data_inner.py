...
class GlobalmapFrontsDataInner(BaseModel):
    """
    ...
    available_extensions: Optional[List[Optional[GlobalmapFrontsDataInnerAvailableExtensionsInner]]] = Field(description="Available modules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "available_extensions": [GlobalmapFrontsDataInnerAvailableExtensionsInner.from_dict(_item) for _item in obj["available_extensions"]] if obj.get("available_extensions") is not None else None,
