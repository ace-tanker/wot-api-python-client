...
class GetClansGlossary200ResponseOneOf(BaseModel):
    """
    GetClansGlossary200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: Dict[str, Any]
    data: Optional[GetClansGlossary200ResponseOneOfData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": obj.get("meta"),
            "data": GetClansGlossary200ResponseOneOfData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
