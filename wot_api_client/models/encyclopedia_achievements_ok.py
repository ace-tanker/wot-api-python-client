...
class EncyclopediaAchievementsOk(BaseModel):
    """
    EncyclopediaAchievementsOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaAchievementsMeta
    data: Optional[Dict[str, Optional[EncyclopediaAchievementsDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaAchievementsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaAchievementsDataValue.from_dict(_v))
