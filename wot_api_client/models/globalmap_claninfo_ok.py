...
class GlobalmapClaninfoOk(BaseModel):
    """
    GlobalmapClaninfoOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapClaninfoMeta
    data: Optional[Dict[str, Optional[GlobalmapClaninfoDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapClaninfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, GlobalmapClaninfoDataValue.from_dict(_v))
