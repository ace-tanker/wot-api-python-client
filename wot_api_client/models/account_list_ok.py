...
class AccountListOk(BaseModel):
    """
    AccountListOk
    """ # noqa: E501
    status: StrictStr
    meta: AccountListMeta
    data: Optional[List[Optional[AccountListDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": AccountListMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
