...
class GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfileAmmoInnerStun(BaseModel):
    """
    Stun characteristics
    """ # noqa: E501
    duration: Dict[str, Any] = Field(description="Stun duration (s) caused by this shell type, a list of values: min, max")
