...
class GlobalmapClanbattlesOk(BaseModel):
    """
    GlobalmapClanbattlesOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapClanbattlesMeta
    data: Optional[List[Optional[GlobalmapClanbattlesDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapClanbattlesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapClanbattlesDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
