...
class GlobalmapInfoOk(BaseModel):
    """
    GlobalmapInfoOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapInfoMeta
    data: Optional[GlobalmapInfoData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapInfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": GlobalmapInfoData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
