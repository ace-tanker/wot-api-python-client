...
class EncyclopediaVehicleprofileErrorErrorOneOf(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['INCOMPATIBLE_MODULE_IDS']):
            raise ValueError("must be one of enum values ('INCOMPATIBLE_MODULE_IDS')")
        return value
