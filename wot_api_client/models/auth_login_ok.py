...
class AuthLoginOk(BaseModel):
    """
    AuthLoginOk
    """ # noqa: E501
    status: StrictStr
    meta: AuthLoginMeta
    data: Optional[AuthLoginData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": AuthLoginMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": AuthLoginData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
