...
class GetEncyclopediaBoosters200ResponseOneOf(BaseModel):
    """
    GetEncyclopediaBoosters200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetAccountList200ResponseOneOfMeta
    data: Optional[Dict[str, Optional[GetEncyclopediaBoosters200ResponseOneOfDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": dict(
                (_k, GetEncyclopediaBoosters200ResponseOneOfDataValue.from_dict(_v))
