...
class EncyclopediaVehicleprofileErrorErrorOneOf1(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PROFILE_NOT_FOUND']):
            raise ValueError("must be one of enum values ('PROFILE_NOT_FOUND')")
        return value
