...
class EncyclopediaVehicleprofileOk(BaseModel):
    """
    EncyclopediaVehicleprofileOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaVehicleprofileMeta
    data: Optional[Dict[str, Optional[EncyclopediaVehicleprofileDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaVehicleprofileMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaVehicleprofileDataValue.from_dict(_v))
