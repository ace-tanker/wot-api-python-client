...
class GlobalmapEventratingneighborsOk(BaseModel):
    """
    GlobalmapEventratingneighborsOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapEventratingneighborsMeta
    data: Optional[List[Optional[GlobalmapEventratingneighborsDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapEventratingneighborsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapEventratingneighborsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
