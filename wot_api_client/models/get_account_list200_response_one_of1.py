...
class GetAccountList200ResponseOneOf1(BaseModel):
    """
    GetAccountList200ResponseOneOf1
    """ # noqa: E501
    status: StrictStr
    error: GetAccountList200ResponseOneOf1Error
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": GetAccountList200ResponseOneOf1Error.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
