...
class GlobalmapSeasonratingneighborsErrorError(BaseModel):
    """
    Ratings not found
    """ # noqa: E501
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RATINGS_NOT_FOUND']):
            raise ValueError("must be one of enum values ('RATINGS_NOT_FOUND')")
        return value
