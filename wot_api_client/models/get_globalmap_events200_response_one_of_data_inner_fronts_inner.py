...
class GetGlobalmapEvents200ResponseOneOfDataInnerFrontsInner(BaseModel):
    """
    GetGlobalmapEvents200ResponseOneOfDataInnerFrontsInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["front_id", "front_name", "url"]
