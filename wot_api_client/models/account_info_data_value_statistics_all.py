...
class AccountInfoDataValueStatisticsAll(BaseModel):
    """
    ...
    avg_damage_assisted_track: Union[StrictFloat, StrictInt] = Field(description="Average damage upon your shooting the track. Value is calculated starting from version 8.8.")
    avg_damage_assisted_radio: Union[StrictFloat, StrictInt] = Field(description="Average damage upon your spotting. Value is calculated starting from version 8.8.")
    avg_damage_assisted: Union[StrictFloat, StrictInt] = Field(description="Average damage caused with your assistance. Value is calculated starting from version 8.8.")
