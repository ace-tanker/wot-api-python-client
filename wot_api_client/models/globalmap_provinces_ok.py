...
class GlobalmapProvincesOk(BaseModel):
    """
    GlobalmapProvincesOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapProvincesMeta
    data: Optional[List[Optional[GlobalmapProvincesDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapProvincesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapProvincesDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
