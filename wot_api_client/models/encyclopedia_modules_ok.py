...
class EncyclopediaModulesOk(BaseModel):
    """
    EncyclopediaModulesOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaModulesMeta
    data: Optional[Dict[str, Optional[EncyclopediaModulesDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaModulesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaModulesDataValue.from_dict(_v))
