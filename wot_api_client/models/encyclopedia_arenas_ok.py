...
class EncyclopediaArenasOk(BaseModel):
    """
    EncyclopediaArenasOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaArenasMeta
    data: Optional[Dict[str, Optional[EncyclopediaArenasDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaArenasMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaArenasDataValue.from_dict(_v))
