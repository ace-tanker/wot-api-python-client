...
class EncyclopediaVehiclesOk(BaseModel):
    """
    EncyclopediaVehiclesOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaVehiclesMeta
    data: Optional[Dict[str, Optional[EncyclopediaVehiclesDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaVehiclesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaVehiclesDataValue.from_dict(_v))
