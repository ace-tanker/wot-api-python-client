...
class GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValueMissionsValue(BaseModel):
    """
    ...
    rewards: Optional[Dict[str, Optional[GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValueMissionsValueRewardsValue]]] = Field(description="Rewards grouped by mission conditions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "rewards": dict(
                (_k, GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValueMissionsValueRewardsValue.from_dict(_v))
