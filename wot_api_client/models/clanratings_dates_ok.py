...
class ClanratingsDatesOk(BaseModel):
    """
    ClanratingsDatesOk
    """ # noqa: E501
    status: StrictStr
    meta: ClanratingsDatesMeta
    data: Optional[Dict[str, Optional[ClanratingsDatesDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClanratingsDatesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, ClanratingsDatesDataValue.from_dict(_v))
