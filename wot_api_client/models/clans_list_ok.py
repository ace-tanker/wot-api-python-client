...
class ClansListOk(BaseModel):
    """
    ClansListOk
    """ # noqa: E501
    status: StrictStr
    meta: ClansListMeta
    data: Optional[List[Optional[ClansListDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClansListMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [ClansListDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
