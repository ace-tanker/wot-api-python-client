...
class GetEncyclopediaArenas200ResponseOneOf(BaseModel):
    """
    GetEncyclopediaArenas200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetAccountList200ResponseOneOfMeta
    data: Optional[Dict[str, Optional[GetEncyclopediaArenas200ResponseOneOfDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": dict(
                (_k, GetEncyclopediaArenas200ResponseOneOfDataValue.from_dict(_v))
