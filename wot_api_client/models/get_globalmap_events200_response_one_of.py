...
class GetGlobalmapEvents200ResponseOneOf(BaseModel):
    """
    GetGlobalmapEvents200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetGlobalmapSeasons200ResponseOneOfMeta
    data: Optional[List[Optional[GetGlobalmapEvents200ResponseOneOfDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetGlobalmapEvents200ResponseOneOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
