...
class GetGlobalmapProvinces200ResponseOneOfDataInnerActiveBattlesInner(BaseModel):
    """
    ...
    clan_a: Optional[GetGlobalmapProvinces200ResponseOneOfDataInnerActiveBattlesInnerClanA]
    clan_b: Optional[GetGlobalmapProvinces200ResponseOneOfDataInnerActiveBattlesInnerClanB]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clan_a": GetGlobalmapProvinces200ResponseOneOfDataInnerActiveBattlesInnerClanA.from_dict(obj["clan_a"]) if obj.get("clan_a") is not None else None,
            "clan_b": GetGlobalmapProvinces200ResponseOneOfDataInnerActiveBattlesInnerClanB.from_dict(obj["clan_b"]) if obj.get("clan_b") is not None else None
        })
        return _obj
