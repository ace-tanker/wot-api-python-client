...
class GetClanratingsClans200ResponseOneOfDataValue(BaseModel):
    """
    ...
    v10l_avg: Optional[GetClanratingsClans200ResponseOneOfDataValueV10lAvg]
    battles_count_avg: Optional[GetClanratingsClans200ResponseOneOfDataValueBattlesCountAvg]
    battles_count_avg_daily: Optional[GetClanratingsClans200ResponseOneOfDataValueBattlesCountAvgDaily]
    global_rating_avg: Optional[GetClanratingsClans200ResponseOneOfDataValueGlobalRatingAvg]
    global_rating_weighted_avg: Optional[GetClanratingsClans200ResponseOneOfDataValueGlobalRatingWeightedAvg]
    efficiency: Optional[GetClanratingsClans200ResponseOneOfDataValueEfficiency]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "v10l_avg": GetClanratingsClans200ResponseOneOfDataValueV10lAvg.from_dict(obj["v10l_avg"]) if obj.get("v10l_avg") is not None else None,
            "battles_count_avg": GetClanratingsClans200ResponseOneOfDataValueBattlesCountAvg.from_dict(obj["battles_count_avg"]) if obj.get("battles_count_avg") is not None else None,
            "battles_count_avg_daily": GetClanratingsClans200ResponseOneOfDataValueBattlesCountAvgDaily.from_dict(obj["battles_count_avg_daily"]) if obj.get("battles_count_avg_daily") is not None else None,
            "global_rating_avg": GetClanratingsClans200ResponseOneOfDataValueGlobalRatingAvg.from_dict(obj["global_rating_avg"]) if obj.get("global_rating_avg") is not None else None,
            "global_rating_weighted_avg": GetClanratingsClans200ResponseOneOfDataValueGlobalRatingWeightedAvg.from_dict(obj["global_rating_weighted_avg"]) if obj.get("global_rating_weighted_avg") is not None else None,
            "efficiency": GetClanratingsClans200ResponseOneOfDataValueEfficiency.from_dict(obj["efficiency"]) if obj.get("efficiency") is not None else None,
