...
class GetAuthLogin200ResponseOneOf(BaseModel):
    """
    GetAuthLogin200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetAccountList200ResponseOneOfMeta
    data: Optional[GetAuthLogin200ResponseOneOfData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetAuthLogin200ResponseOneOfData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
