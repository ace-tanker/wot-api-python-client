...
class StrongholdActivateclanreserveErrorError(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RESERVE_ACTIVATION_ERROR']):
            raise ValueError("must be one of enum values ('RESERVE_ACTIVATION_ERROR')")
        return value
