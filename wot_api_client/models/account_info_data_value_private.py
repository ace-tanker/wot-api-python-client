...
class AccountInfoDataValuePrivate(BaseModel):
    """
    ...
    rented: Optional[Dict[str, Optional[AccountInfoDataValuePrivateRentedValue]]] = Field(default=None, description="Vehicle Rental.")
    grouped_contacts: Optional[AccountInfoDataValuePrivateGroupedContacts] = None
    restrictions: Optional[AccountInfoDataValuePrivateRestrictions]
    is_bound_to_phone: StrictBool = Field(description="Indicates if mobile phone number was added to the account")
    boosters: Optional[Dict[str, Optional[AccountInfoDataValuePrivateBoostersValue]]] = Field(default=None, description="Personal Reserves.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rented": dict(
                (_k, AccountInfoDataValuePrivateRentedValue.from_dict(_v))
                for _k, _v in obj["rented"].items()
            )
            if obj.get("rented") is not None
            else None,
            "grouped_contacts": AccountInfoDataValuePrivateGroupedContacts.from_dict(obj["grouped_contacts"]) if obj.get("grouped_contacts") is not None else None,
            "restrictions": AccountInfoDataValuePrivateRestrictions.from_dict(obj["restrictions"]) if obj.get("restrictions") is not None else None,
            "is_bound_to_phone": obj.get("is_bound_to_phone"),
            "boosters": dict(
                (_k, AccountInfoDataValuePrivateBoostersValue.from_dict(_v))
