...
class EncyclopediaBadgesOk(BaseModel):
    """
    EncyclopediaBadgesOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaBadgesMeta
    data: Optional[Dict[str, Optional[EncyclopediaBadgesDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaBadgesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaBadgesDataValue.from_dict(_v))
