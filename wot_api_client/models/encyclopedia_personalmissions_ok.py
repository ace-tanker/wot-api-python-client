...
class EncyclopediaPersonalmissionsOk(BaseModel):
    """
    EncyclopediaPersonalmissionsOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaPersonalmissionsMeta
    data: Optional[Dict[str, Optional[EncyclopediaPersonalmissionsDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaPersonalmissionsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaPersonalmissionsDataValue.from_dict(_v))
