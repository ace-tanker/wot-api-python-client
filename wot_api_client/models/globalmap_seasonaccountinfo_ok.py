...
class GlobalmapSeasonaccountinfoOk(BaseModel):
    """
    GlobalmapSeasonaccountinfoOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapSeasonaccountinfoMeta
    data: Optional[Dict[str, Optional[GlobalmapSeasonaccountinfoDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapSeasonaccountinfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, GlobalmapSeasonaccountinfoDataValue.from_dict(_v))
