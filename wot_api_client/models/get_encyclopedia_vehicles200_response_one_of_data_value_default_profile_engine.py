...
class GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfileEngine(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tier", "name", "weight", "tag", "power", "fire_chance"]
