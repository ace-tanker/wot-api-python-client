...
class ClansInfoOk(BaseModel):
    """
    ClansInfoOk
    """ # noqa: E501
    status: StrictStr
    meta: ClansInfoMeta
    data: Optional[Dict[str, Optional[ClansInfoDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClansInfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, ClansInfoDataValue.from_dict(_v))
