...
class GetEncyclopediaVehicles200ResponseOneOfDataValue(BaseModel):
    """
    ...
    images: Optional[GetEncyclopediaVehicles200ResponseOneOfDataValueImages]
    ...
    default_profile: Optional[GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile]
    ...
    modules_tree: Optional[Dict[str, Optional[GetEncyclopediaVehicles200ResponseOneOfDataValueModulesTreeValue]]] = Field(description="Module research information")
    crew: Optional[List[Optional[GetEncyclopediaVehicles200ResponseOneOfDataValueCrewInner]]] = Field(description="Crew")
    multination: Optional[Dict[str, Optional[GetEncyclopediaVehicles200ResponseOneOfDataValueMultinationValue]]] = Field(description="Информация об мультинации")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": GetEncyclopediaVehicles200ResponseOneOfDataValueImages.from_dict(obj["images"]) if obj.get("images") is not None else None,
            "price_credit": obj.get("price_credit"),
            "price_gold": obj.get("price_gold"),
            "prices_xp": obj.get("prices_xp"),
            "next_tanks": obj.get("next_tanks"),
            "default_profile": GetEncyclopediaVehicles200ResponseOneOfDataValueDefaultProfile.from_dict(obj["default_profile"]) if obj.get("default_profile") is not None else None,
            "guns": obj.get("guns"),
            ...
            "modules_tree": dict(
                (_k, GetEncyclopediaVehicles200ResponseOneOfDataValueModulesTreeValue.from_dict(_v))
                for _k, _v in obj["modules_tree"].items()
            )
            if obj.get("modules_tree") is not None
            else None,
            "crew": [GetEncyclopediaVehicles200ResponseOneOfDataValueCrewInner.from_dict(_item) for _item in obj["crew"]] if obj.get("crew") is not None else None,
            "multination": dict(
                (_k, GetEncyclopediaVehicles200ResponseOneOfDataValueMultinationValue.from_dict(_v))
