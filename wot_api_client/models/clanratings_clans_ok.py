...
class ClanratingsClansOk(BaseModel):
    """
    ClanratingsClansOk
    """ # noqa: E501
    status: StrictStr
    meta: ClanratingsClansMeta
    data: Optional[Dict[str, Optional[ClanratingsClansDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClanratingsClansMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, ClanratingsClansDataValue.from_dict(_v))
