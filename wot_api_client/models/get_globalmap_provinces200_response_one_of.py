...
class GetGlobalmapProvinces200ResponseOneOf(BaseModel):
    """
    GetGlobalmapProvinces200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetAccountList200ResponseOneOfMeta
    data: Optional[List[Optional[GetGlobalmapProvinces200ResponseOneOfDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetGlobalmapProvinces200ResponseOneOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
