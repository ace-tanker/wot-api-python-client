...
class GetAccountInfo200ResponseOneOfDataValue(BaseModel):
    """
    GetAccountInfo200ResponseOneOfDataValue
    """ # noqa: E501
    statistics: Optional[GetAccountInfo200ResponseOneOfDataValueStatistics]
    ...
    private: Optional[GetAccountInfo200ResponseOneOfDataValuePrivate]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statistics": GetAccountInfo200ResponseOneOfDataValueStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            ...
            "private": GetAccountInfo200ResponseOneOfDataValuePrivate.from_dict(obj["private"]) if obj.get("private") is not None else None,
