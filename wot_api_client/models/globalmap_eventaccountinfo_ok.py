...
class GlobalmapEventaccountinfoOk(BaseModel):
    """
    GlobalmapEventaccountinfoOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapEventaccountinfoMeta
    data: Optional[Dict[str, Optional[GlobalmapEventaccountinfoDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapEventaccountinfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, GlobalmapEventaccountinfoDataValue.from_dict(_v))
