...
class AccountListErrorErrorOneOf1(BaseModel):
    """
    **Search** parameter is not long enough. Allowed value depends on **type** parameter.
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NOT_ENOUGH_SEARCH_LENGTH']):
            raise ValueError("must be one of enum values ('NOT_ENOUGH_SEARCH_LENGTH')")
        return value
