...
class GlobalmapEventclaninfoOk(BaseModel):
    """
    GlobalmapEventclaninfoOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapEventclaninfoMeta
    data: Optional[Dict[str, Optional[GlobalmapEventclaninfoDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapEventclaninfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, GlobalmapEventclaninfoDataValue.from_dict(_v))
