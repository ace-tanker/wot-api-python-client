...
class GlobalmapEventaccountratingneighborsOk(BaseModel):
    """
    GlobalmapEventaccountratingneighborsOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapEventaccountratingneighborsMeta
    data: Optional[List[Optional[GlobalmapEventaccountratingsDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapEventaccountratingneighborsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapEventaccountratingsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
