...
class StrongholdClanreservesOk(BaseModel):
    """
    StrongholdClanreservesOk
    """ # noqa: E501
    status: StrictStr
    meta: StrongholdClanreservesMeta
    data: Optional[List[Optional[StrongholdClanreservesDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": StrongholdClanreservesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [StrongholdClanreservesDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
