...
class GetAccountInfo200ResponseOneOfDataValueStatisticsFallout(BaseModel):
    """
    Fallout statistics.
    """ # noqa: E501
    ...
    win_points: StrictInt = Field(description="Victory Points")
    flag_capture: StrictInt = Field(description="Flags captured in platoon")
    flag_capture_solo: StrictInt = Field(description="Flags captured as solo player")
    avatar_damage_dealt: StrictInt = Field(description="Damage caused by Combat Reserves")
    avatar_frags: StrictInt = Field(description="Destroyed by Combat Reserves")
    resource_absorbed: StrictInt = Field(description="Resources captured at resource points")
    death_count: StrictInt = Field(description="Deaths")
    max_win_points: StrictInt = Field(description="Maximum Victory Points earned in Fallout")
    max_frags_with_avatar: StrictInt = Field(description="Maximum destroyed in one battle including vehicles destroyed by avatar")
    max_damage_with_avatar: StrictInt = Field(description="Maximum damage caused in one battle including damage from avatar")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "win_points": obj.get("win_points"),
            "flag_capture": obj.get("flag_capture"),
            "flag_capture_solo": obj.get("flag_capture_solo"),
            "avatar_damage_dealt": obj.get("avatar_damage_dealt"),
            "avatar_frags": obj.get("avatar_frags"),
            "resource_absorbed": obj.get("resource_absorbed"),
            "death_count": obj.get("death_count"),
            "max_win_points": obj.get("max_win_points"),
            "max_frags_with_avatar": obj.get("max_frags_with_avatar"),
            "max_damage_with_avatar": obj.get("max_damage_with_avatar"),
