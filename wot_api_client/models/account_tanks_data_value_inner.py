...
class AccountTanksDataValueInner(BaseModel):
    """
    ...
    statistics: Optional[AccountTanksDataValueInnerStatistics]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statistics": AccountTanksDataValueInnerStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None
        })
        return _obj
