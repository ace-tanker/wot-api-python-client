...
class EncyclopediaInfoOk(BaseModel):
    """
    EncyclopediaInfoOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaInfoMeta
    data: Optional[EncyclopediaInfoData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaInfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": EncyclopediaInfoData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
