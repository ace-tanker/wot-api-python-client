...
class GetStrongholdClaninfo200ResponseOneOfDataValueBattlesForStrongholdsStatistics(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["total_10", "win_10", "lose_10", "total_10_in_28d", "win_10_in_28d", "last_time_10"]
