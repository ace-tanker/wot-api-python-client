...
class GetEncyclopediaModules200ResponseOneOf(BaseModel):
    """
    GetEncyclopediaModules200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetEncyclopediaProvisions200ResponseOneOfMeta
    data: Optional[Dict[str, Optional[GetEncyclopediaModules200ResponseOneOfDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": dict(
                (_k, GetEncyclopediaModules200ResponseOneOfDataValue.from_dict(_v))
