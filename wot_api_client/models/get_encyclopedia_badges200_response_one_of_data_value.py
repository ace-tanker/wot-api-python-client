...
class GetEncyclopediaBadges200ResponseOneOfDataValue(BaseModel):
    """
    ...
    images: Optional[GetEncyclopediaBadges200ResponseOneOfDataValueImages]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": GetEncyclopediaBadges200ResponseOneOfDataValueImages.from_dict(obj["images"]) if obj.get("images") is not None else None
        })
        return _obj
