...
class StrongholdClaninfoDataValue(BaseModel):
    """
    ...
    building_slots: Optional[List[Optional[StrongholdClaninfoDataValueBuildingSlotsInner]]] = Field(description="Information about the Stronghold's construction sites")
    skirmish_statistics: Optional[StrongholdClaninfoDataValueSkirmishStatistics]
    battles_for_strongholds_statistics: Optional[StrongholdClaninfoDataValueBattlesForStrongholdsStatistics]
    battles_series_for_strongholds_statistics: Optional[StrongholdClaninfoDataValueBattlesSeriesForStrongholdsStatistics]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "building_slots": [StrongholdClaninfoDataValueBuildingSlotsInner.from_dict(_item) for _item in obj["building_slots"]] if obj.get("building_slots") is not None else None,
            "skirmish_statistics": StrongholdClaninfoDataValueSkirmishStatistics.from_dict(obj["skirmish_statistics"]) if obj.get("skirmish_statistics") is not None else None,
            "battles_for_strongholds_statistics": StrongholdClaninfoDataValueBattlesForStrongholdsStatistics.from_dict(obj["battles_for_strongholds_statistics"]) if obj.get("battles_for_strongholds_statistics") is not None else None,
            "battles_series_for_strongholds_statistics": StrongholdClaninfoDataValueBattlesSeriesForStrongholdsStatistics.from_dict(obj["battles_series_for_strongholds_statistics"]) if obj.get("battles_series_for_strongholds_statistics") is not None else None
        })
        return _obj
