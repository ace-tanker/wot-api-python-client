...
class GetGlobalmapProvinces200ResponseOneOfDataInner(BaseModel):
    """
    ...
    active_battles: Optional[List[Optional[GetGlobalmapProvinces200ResponseOneOfDataInnerActiveBattlesInner]]] = Field(description="Current battles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "active_battles": [GetGlobalmapProvinces200ResponseOneOfDataInnerActiveBattlesInner.from_dict(_item) for _item in obj["active_battles"]] if obj.get("active_battles") is not None else None,
