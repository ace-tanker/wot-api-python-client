...
class GetGlobalmapEventaccountratings200ResponseOneOf(BaseModel):
    """
    GetGlobalmapEventaccountratings200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetGlobalmapSeasons200ResponseOneOfMeta
    data: Optional[List[Optional[GetGlobalmapEventaccountratings200ResponseOneOfDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GetGlobalmapSeasons200ResponseOneOfMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GetGlobalmapEventaccountratings200ResponseOneOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
