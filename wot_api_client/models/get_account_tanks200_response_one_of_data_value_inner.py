...
class GetAccountTanks200ResponseOneOfDataValueInner(BaseModel):
    """
    ...
    statistics: Optional[GetAccountTanks200ResponseOneOfDataValueInnerStatistics]
    __properties: ClassVar[List[str]] = ["tank_id", "mark_of_mastery", "statistics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statistics": GetAccountTanks200ResponseOneOfDataValueInnerStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None
        })
        return _obj
