...
class GlobalmapEventsOk(BaseModel):
    """
    GlobalmapEventsOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapEventsMeta
    data: Optional[List[Optional[GlobalmapEventsDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapEventsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapEventsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
