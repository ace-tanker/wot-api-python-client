...
class GetEncyclopediaProvisions200ResponseOneOf(BaseModel):
    """
    GetEncyclopediaProvisions200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetEncyclopediaProvisions200ResponseOneOfMeta
    data: Optional[Dict[str, Optional[GetEncyclopediaProvisions200ResponseOneOfDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GetEncyclopediaProvisions200ResponseOneOfMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, GetEncyclopediaProvisions200ResponseOneOfDataValue.from_dict(_v))
