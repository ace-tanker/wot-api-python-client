...
class StrongholdActivateclanreserveOk(BaseModel):
    """
    StrongholdActivateclanreserveOk
    """ # noqa: E501
    status: StrictStr
    meta: StrongholdActivateclanreserveMeta
    data: Optional[StrongholdActivateclanreserveData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": StrongholdActivateclanreserveMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": StrongholdActivateclanreserveData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
