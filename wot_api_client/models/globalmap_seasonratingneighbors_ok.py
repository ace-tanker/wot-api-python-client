...
class GlobalmapSeasonratingneighborsOk(BaseModel):
    """
    GlobalmapSeasonratingneighborsOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapSeasonratingneighborsMeta
    data: Optional[List[Optional[GlobalmapSeasonratingDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapSeasonratingneighborsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapSeasonratingDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
