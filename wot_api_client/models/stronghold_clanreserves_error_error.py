...
class StrongholdClanreservesErrorError(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ACCOUNT_NOT_IN_CLAN']):
            raise ValueError("must be one of enum values ('ACCOUNT_NOT_IN_CLAN')")
        return value
