...
class GetEncyclopediaVehicles200ResponseOneOfDataValueMultinationValue(BaseModel):
    """
    GetEncyclopediaVehicles200ResponseOneOfDataValueMultinationValue
    """ # noqa: E501
    tank_id: StrictInt = Field(description="Vehicle ID")
    is_default: StrictBool = Field(description="Признак нации по-умолчанию")
    __properties: ClassVar[List[str]] = ["tank_id", "is_default"]
