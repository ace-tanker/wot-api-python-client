...
class GetGlobalmapEvents200ResponseOneOfDataInner(BaseModel):
    """
    ...
    fronts: Optional[List[Optional[GetGlobalmapEvents200ResponseOneOfDataInnerFrontsInner]]] = Field(description="Fronts. Only event fronts are presented in response.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fronts": [GetGlobalmapEvents200ResponseOneOfDataInnerFrontsInner.from_dict(_item) for _item in obj["fronts"]] if obj.get("fronts") is not None else None
        })
        return _obj
