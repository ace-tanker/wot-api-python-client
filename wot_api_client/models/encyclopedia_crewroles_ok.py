...
class EncyclopediaCrewrolesOk(BaseModel):
    """
    EncyclopediaCrewrolesOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaCrewrolesMeta
    data: Optional[Dict[str, Optional[EncyclopediaCrewrolesDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaCrewrolesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaCrewrolesDataValue.from_dict(_v))
