...
class EncyclopediaCrewskillsOk(BaseModel):
    """
    EncyclopediaCrewskillsOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaCrewskillsMeta
    data: Optional[Dict[str, Optional[EncyclopediaCrewskillsDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaCrewskillsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaCrewskillsDataValue.from_dict(_v))
