...
class AccountListErrorErrorOneOf2(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SEARCH_LIST_LIMIT_EXCEEDED']):
            raise ValueError("must be one of enum values ('SEARCH_LIST_LIMIT_EXCEEDED')")
        return value
