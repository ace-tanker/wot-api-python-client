...
class EncyclopediaModulesDataValueDefaultProfile(BaseModel):
    """
    Basic technical characteristics of module.
    """ # noqa: E501
    gun: Optional[EncyclopediaModulesDataValueDefaultProfileGun]
    engine: Optional[EncyclopediaModulesDataValueDefaultProfileEngine]
    turret: Optional[EncyclopediaModulesDataValueDefaultProfileTurret]
    suspension: Optional[EncyclopediaModulesDataValueDefaultProfileSuspension]
    radio: Optional[EncyclopediaModulesDataValueDefaultProfileRadio]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gun": EncyclopediaModulesDataValueDefaultProfileGun.from_dict(obj["gun"]) if obj.get("gun") is not None else None,
            "engine": EncyclopediaModulesDataValueDefaultProfileEngine.from_dict(obj["engine"]) if obj.get("engine") is not None else None,
            "turret": EncyclopediaModulesDataValueDefaultProfileTurret.from_dict(obj["turret"]) if obj.get("turret") is not None else None,
            "suspension": EncyclopediaModulesDataValueDefaultProfileSuspension.from_dict(obj["suspension"]) if obj.get("suspension") is not None else None,
            "radio": EncyclopediaModulesDataValueDefaultProfileRadio.from_dict(obj["radio"]) if obj.get("radio") is not None else None
        })
        return _obj
