...
class EncyclopediaBoostersOk(BaseModel):
    """
    EncyclopediaBoostersOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaBoostersMeta
    data: Optional[Dict[str, Optional[EncyclopediaBoostersDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaBoostersMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaBoostersDataValue.from_dict(_v))
