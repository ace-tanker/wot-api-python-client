...
class ClanratingsTypesOk(BaseModel):
    """
    ClanratingsTypesOk
    """ # noqa: E501
    status: StrictStr
    meta: ClanratingsTypesMeta
    data: Optional[Dict[str, Optional[ClanratingsTypesDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClanratingsTypesMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, ClanratingsTypesDataValue.from_dict(_v))
