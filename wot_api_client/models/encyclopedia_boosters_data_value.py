...
class EncyclopediaBoostersDataValue(BaseModel):
    """
    ...
    images: Optional[EncyclopediaBoostersDataValueImages]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": EncyclopediaBoostersDataValueImages.from_dict(obj["images"]) if obj.get("images") is not None else None,
