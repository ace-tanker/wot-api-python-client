...
class StrongholdClanreservesDataInnerInStockInner(BaseModel):
    """
    StrongholdClanreservesDataInnerInStockInner
    """ # noqa: E501
    amount: StrictInt = Field(description="Number of clan Reserves of each level")
    bonus_values: Optional[List[Optional[StrongholdClanreservesDataInnerInStockInnerBonusValuesInner]]] = Field(description="Reserve efficiencies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bonus_values": [StrongholdClanreservesDataInnerInStockInnerBonusValuesInner.from_dict(_item) for _item in obj["bonus_values"]] if obj.get("bonus_values") is not None else None,
