...
class TanksMasteryOk(BaseModel):
    """
    TanksMasteryOk
    """ # noqa: E501
    status: StrictStr
    meta: TanksMasteryMeta
    data: Optional[TanksMasteryData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": TanksMasteryMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": TanksMasteryData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
