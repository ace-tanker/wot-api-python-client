...
class GetEncyclopediaVehicles200ResponseOneOf(BaseModel):
    """
    GetEncyclopediaVehicles200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetEncyclopediaVehicles200ResponseOneOfMeta
    data: Optional[Dict[str, Optional[GetEncyclopediaVehicles200ResponseOneOfDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GetEncyclopediaVehicles200ResponseOneOfMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, GetEncyclopediaVehicles200ResponseOneOfDataValue.from_dict(_v))
