...
class EncyclopediaProvisionsOk(BaseModel):
    """
    EncyclopediaProvisionsOk
    """ # noqa: E501
    status: StrictStr
    meta: EncyclopediaProvisionsMeta
    data: Optional[Dict[str, Optional[EncyclopediaProvisionsDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": EncyclopediaProvisionsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, EncyclopediaProvisionsDataValue.from_dict(_v))
