...
class GlobalmapClaninfoDataValue(BaseModel):
    """
    ...
    statistics: Optional[GlobalmapClaninfoDataValueStatistics]
    ratings: Optional[GlobalmapClaninfoDataValueRatings]
    private: Optional[GlobalmapClaninfoDataValuePrivate]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "name": obj.get("name"),
            "statistics": GlobalmapClaninfoDataValueStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            "ratings": GlobalmapClaninfoDataValueRatings.from_dict(obj["ratings"]) if obj.get("ratings") is not None else None,
            "private": GlobalmapClaninfoDataValuePrivate.from_dict(obj["private"]) if obj.get("private") is not None else None
        })
        return _obj
