...
class GlobalmapEventratingOk(BaseModel):
    """
    GlobalmapEventratingOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapEventratingMeta
    data: Optional[List[Optional[GlobalmapEventratingDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapEventratingMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapEventratingDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
