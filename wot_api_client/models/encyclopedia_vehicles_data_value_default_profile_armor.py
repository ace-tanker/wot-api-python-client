...
class EncyclopediaVehiclesDataValueDefaultProfileArmor(BaseModel):
    """
    Armor
    """ # noqa: E501
    hull: Optional[EncyclopediaVehiclesDataValueDefaultProfileArmorHull]
    turret: Optional[EncyclopediaVehiclesDataValueDefaultProfileArmorTurret]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hull": EncyclopediaVehiclesDataValueDefaultProfileArmorHull.from_dict(obj["hull"]) if obj.get("hull") is not None else None,
            "turret": EncyclopediaVehiclesDataValueDefaultProfileArmorTurret.from_dict(obj["turret"]) if obj.get("turret") is not None else None
        })
        return _obj
