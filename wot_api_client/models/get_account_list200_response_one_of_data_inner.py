...
class GetAccountList200ResponseOneOfDataInner(BaseModel):
    """
    GetAccountList200ResponseOneOfDataInner
    """ # noqa: E501
    account_id: StrictInt = Field(description="Player ID")
    nickname: StrictStr = Field(description="Player name")
    __properties: ClassVar[List[str]] = ["account_id", "nickname"]
