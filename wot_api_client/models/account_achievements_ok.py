...
class AccountAchievementsOk(BaseModel):
    """
    AccountAchievementsOk
    """ # noqa: E501
    status: StrictStr
    meta: AccountAchievementsMeta
    data: Optional[Dict[str, Optional[AccountAchievementsDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": AccountAchievementsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, AccountAchievementsDataValue.from_dict(_v))
