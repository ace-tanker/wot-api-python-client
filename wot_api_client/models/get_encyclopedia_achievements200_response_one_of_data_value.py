...
class GetEncyclopediaAchievements200ResponseOneOfDataValue(BaseModel):
    """
    ...
    options: Optional[List[Optional[GetEncyclopediaAchievements200ResponseOneOfDataValueOptionsInner]]] = Field(description="Service Record")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": obj.get("order"),
            "options": [GetEncyclopediaAchievements200ResponseOneOfDataValueOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
