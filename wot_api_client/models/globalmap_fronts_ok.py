...
class GlobalmapFrontsOk(BaseModel):
    """
    GlobalmapFrontsOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapFrontsMeta
    data: Optional[List[Optional[GlobalmapFrontsDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapFrontsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapFrontsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
