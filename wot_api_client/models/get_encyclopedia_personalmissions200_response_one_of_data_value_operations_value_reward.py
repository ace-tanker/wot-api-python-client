...
class GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValueReward(BaseModel):
    """
    Reward for operation
    """ # noqa: E501
    slots: Optional[StrictInt] = Field(description="Slots")
    tanks: List[StrictInt] = Field(description="Vehicle IDs")
    __properties: ClassVar[List[str]] = ["slots", "tanks"]
