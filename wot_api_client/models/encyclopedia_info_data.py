...
class EncyclopediaInfoData(BaseModel):
    """
    ...
    achievement_sections: Optional[Dict[str, Optional[EncyclopediaInfoDataAchievementSectionsValue]]] = Field(description="Award sections")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "achievement_sections": dict(
                (_k, EncyclopediaInfoDataAchievementSectionsValue.from_dict(_v))
