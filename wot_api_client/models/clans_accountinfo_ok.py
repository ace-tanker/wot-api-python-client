...
class ClansAccountinfoOk(BaseModel):
    """
    ClansAccountinfoOk
    """ # noqa: E501
    status: StrictStr
    meta: ClansAccountinfoMeta
    data: Optional[Dict[str, Optional[ClansAccountinfoDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClansAccountinfoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": dict(
                (_k, ClansAccountinfoDataValue.from_dict(_v))
