...
class GlobalmapSeasonsOk(BaseModel):
    """
    GlobalmapSeasonsOk
    """ # noqa: E501
    status: StrictStr
    meta: GlobalmapSeasonsMeta
    data: Optional[List[Optional[GlobalmapSeasonsDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GlobalmapSeasonsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [GlobalmapSeasonsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
