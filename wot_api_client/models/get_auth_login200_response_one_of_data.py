...
class GetAuthLogin200ResponseOneOfData(BaseModel):
    """
    GetAuthLogin200ResponseOneOfData
    """ # noqa: E501
    location: StrictStr = Field(description="URL where user is redirected for authentication. This URL is returned only if parameter **nofollow=1** is passed in.")
