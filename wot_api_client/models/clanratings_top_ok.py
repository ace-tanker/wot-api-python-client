...
class ClanratingsTopOk(BaseModel):
    """
    ClanratingsTopOk
    """ # noqa: E501
    status: StrictStr
    meta: ClanratingsTopMeta
    data: Optional[List[Optional[ClanratingsTopDataInner]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClanratingsTopMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [ClanratingsTopDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
