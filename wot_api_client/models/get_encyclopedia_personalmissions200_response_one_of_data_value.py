...
class GetEncyclopediaPersonalmissions200ResponseOneOfDataValue(BaseModel):
    """
    ...
    operations: Optional[Dict[str, Optional[GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue]]] = Field(description="Campaign operations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operations": dict(
                (_k, GetEncyclopediaPersonalmissions200ResponseOneOfDataValueOperationsValue.from_dict(_v))
