...
class EncyclopediaModulesDataValue(BaseModel):
    """
    ...
    default_profile: Optional[EncyclopediaModulesDataValueDefaultProfile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tanks": obj.get("tanks"),
            "default_profile": EncyclopediaModulesDataValueDefaultProfile.from_dict(obj["default_profile"]) if obj.get("default_profile") is not None else None
        })
        return _obj
