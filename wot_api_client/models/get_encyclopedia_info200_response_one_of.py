...
class GetEncyclopediaInfo200ResponseOneOf(BaseModel):
    """
    GetEncyclopediaInfo200ResponseOneOf
    """ # noqa: E501
    status: StrictStr
    meta: GetAccountList200ResponseOneOfMeta
    data: Optional[GetEncyclopediaInfo200ResponseOneOfData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetEncyclopediaInfo200ResponseOneOfData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
