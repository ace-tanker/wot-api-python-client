...
class StrongholdActivateclanreserveError(BaseModel):
    """
    StrongholdActivateclanreserveError
    """ # noqa: E501
    status: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": StrongholdActivateclanreserveErrorError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
