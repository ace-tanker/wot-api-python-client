...
class ClanratingsNeighborsOk(BaseModel):
    """
    ClanratingsNeighborsOk
    """ # noqa: E501
    status: StrictStr
    meta: ClanratingsNeighborsMeta
    data: Optional[List[Optional[ClanratingsClansDataValue]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ClanratingsNeighborsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [ClanratingsClansDataValue.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
