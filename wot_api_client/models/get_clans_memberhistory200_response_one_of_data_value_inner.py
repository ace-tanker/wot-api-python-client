...
class GetClansMemberhistory200ResponseOneOfDataValueInner(BaseModel):
    """
    ...
    left_at: StrictInt = Field(description="Date when player left clan")
    role: StrictStr = Field(description="Last position in clan")
    __properties: ClassVar[List[str]] = ["account_id", "clan_id", "joined_at", "left_at", "role"]
