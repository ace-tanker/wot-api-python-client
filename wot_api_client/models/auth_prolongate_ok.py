...
class AuthProlongateOk(BaseModel):
    """
    AuthProlongateOk
    """ # noqa: E501
    status: StrictStr
    meta: AuthProlongateMeta
    data: Optional[AuthProlongateData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": AuthProlongateMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": AuthProlongateData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
