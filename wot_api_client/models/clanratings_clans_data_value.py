...
class ClanratingsClansDataValue(BaseModel):
    """
    ...
    v10l_avg: Optional[ClanratingsClansDataValueV10lAvg]
    battles_count_avg: Optional[ClanratingsClansDataValueBattlesCountAvg]
    battles_count_avg_daily: Optional[ClanratingsClansDataValueBattlesCountAvgDaily]
    global_rating_avg: Optional[ClanratingsClansDataValueGlobalRatingAvg]
    global_rating_weighted_avg: Optional[ClanratingsClansDataValueGlobalRatingWeightedAvg]
    efficiency: Optional[ClanratingsClansDataValueEfficiency]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "v10l_avg": ClanratingsClansDataValueV10lAvg.from_dict(obj["v10l_avg"]) if obj.get("v10l_avg") is not None else None,
            "battles_count_avg": ClanratingsClansDataValueBattlesCountAvg.from_dict(obj["battles_count_avg"]) if obj.get("battles_count_avg") is not None else None,
            "battles_count_avg_daily": ClanratingsClansDataValueBattlesCountAvgDaily.from_dict(obj["battles_count_avg_daily"]) if obj.get("battles_count_avg_daily") is not None else None,
            "global_rating_avg": ClanratingsClansDataValueGlobalRatingAvg.from_dict(obj["global_rating_avg"]) if obj.get("global_rating_avg") is not None else None,
            "global_rating_weighted_avg": ClanratingsClansDataValueGlobalRatingWeightedAvg.from_dict(obj["global_rating_weighted_avg"]) if obj.get("global_rating_weighted_avg") is not None else None,
            "efficiency": ClanratingsClansDataValueEfficiency.from_dict(obj["efficiency"]) if obj.get("efficiency") is not None else None,
